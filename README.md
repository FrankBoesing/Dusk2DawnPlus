...
> This fork has been modernized to use current C++ features (`constexpr`, `noexcept`, fixed-size array references, etc.) for better compile-time evaluation and safety on microcontrollers.
